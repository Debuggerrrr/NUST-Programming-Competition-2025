...
<head>
    <meta charset="UTF-8">
    <title>MESMTF Nurse Dashboard</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark dashboard-header mb-4">
        <div class="container">
            <a class="navbar-brand" href="#"><i class="fas fa-user-nurse me-2"></i>MESMTF Nurse Portal</a>
            ...
            <div class="col-md-3 mb-3">
                <div class="sidebar p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link" href="#" data-section="vitalsSection"><i class="fas fa-heartbeat me-2"></i> Patient Vitals</a>
            ...
            <div class="col-md-9">
                ...
                <div class="section-content" id="dashboardSection">
                    <div class="card summary-card mb-4">
                        <div class="card-body">
                            ...
                            <div>
                                <a href="#" class="btn btn-success me-2 mb-2"><i class="fas fa-heartbeat me-1"></i> Record Vitals</a>
                                <a href="#" class="btn btn-info me-2 mb-2"><i class="fas fa-calendar-plus me-1"></i> Manage Appointments</a>
                                <a href="#" class="btn btn-warning me-2 mb-2"><i class="fas fa-syringe me-1"></i> Administer Drugs</a>
                                <a href="#" class="btn btn-secondary mb-2"><i class="fas fa-user-injured me-1"></i> Update Records</a>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Patient Vitals Section -->
                <div class="section-content d-none" id="vitalsSection">
                    <div class="card summary-card">
                        <div class="card-header bg-primary text-white"><i class="fas fa-heartbeat me-2"></i> Patient Vitals</div>
                        <div class="card-body">
                            <p>Record and view patient vitals (temperature, blood pressure, pulse, etc).</p>
                            <div class="alert alert-info">Vitals recording interface coming soon.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-content d-none" id="appointmentsSection">
                    <div class="card summary-card">
                        ...
                        <div class="card-body">
                            <p>Manage appointments for patients.</p>
                            <div class="alert alert-info">Appointments management interface coming soon.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-content d-none" id="drugAdminSection">
                    <div class="card summary-card">
                        ...
                        <div class="card-body">
                            <p>Administer drugs and update records.</p>
                            <div class="alert alert-info">Drug administration interface coming soon.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-content d-none" id="medicalRecordsSection">
                    <div class="card summary-card">
                        <div class="card-header bg-secondary text-white"><i class="fas fa-user-injured me-2"></i> Medical Records</div>
                        <div class="card-body">
                            <p>View and update patient medical records.</p>
                            <div class="alert alert-info">Medical records interface coming soon.</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="p-4">
            ...
            <form id="editProfileForm" method="POST" enctype="multipart/form-data" action="edit_profile.php">
                ...
                <div class="row g-2">
                    ...
                    <?php if ($sidebarUser->role === 'nurse'): ?>
                    <div class="col-6 mb-2">
                        <label for="department" class="form-label">Department</label>
                        <input type="text" class="form-control form-control-sm" id="department" name="department" value="<?php echo htmlspecialchars($sidebarUser->department); ?>">
                    </div>
                    <?php endif; ?>
